...
const Contract_Address = "0xA080367f4aCA66288B482d0FAC9E6126F1350100";
...
export const loadData = async () => {
    ...
    const Contract_Web3_Conection = new window.web3.eth.Contract(Web3Conection.output.abi, Contract_Address);
