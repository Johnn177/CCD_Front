...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Web3 Coneccion</title>
        <meta name="descripcion" content="Conexion Simple web3" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <h1>Coneccion Web3</h1>

      <button onClick={handleWeb3}>Conectar con billetera </button>

      <h3>Numero: {number}</h3>

      <input type='number' value={inputValue} onChange={(e) => setInputValue(e.currentTarget.value) } placeholder="Escribe un numero"/>
